...
Version  : 4.7
Release  : 36
URL      : https://github.com/clearlinux/clear-config-management/archive/4.7.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/4.7.tar.gz
...
%prep
%setup -q -n clear-config-management-4.7

...
Version  : 5.1
Release  : 39
URL      : https://github.com/clearlinux/clear-config-management/archive/5.1.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/5.1.tar.gz
...
%prep
%setup -q -n clear-config-management-5.1

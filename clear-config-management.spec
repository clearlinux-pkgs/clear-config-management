...
Version  : 3.1
Release  : 20
URL      : https://github.com/clearlinux/clear-config-management/archive/3.1.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/3.1.tar.gz
...
%prep
%setup -q -n clear-config-management-3.1

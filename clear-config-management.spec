...
Version  : 3.5
Release  : 24
URL      : https://github.com/clearlinux/clear-config-management/archive/3.5.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/3.5.tar.gz
...
%prep
%setup -q -n clear-config-management-3.5

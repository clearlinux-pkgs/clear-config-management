...
Version  : 2.6
Release  : 17
URL      : https://github.com/clearlinux/clear-config-management/archive/2.6.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/2.6.tar.gz
...
%prep
%setup -q -n clear-config-management-2.6
...
/usr/share/ansible/roles/os-horizon/tasks/configure_horizon.yml
/usr/share/ansible/roles/os-horizon/tasks/install.yml
/usr/share/ansible/roles/os-horizon/tasks/main.yml
/usr/share/ansible/roles/os-horizon/templates/10_host.py.j2

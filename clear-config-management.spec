...
Version  : 2.5
Release  : 15
URL      : https://github.com/clearlinux/clear-config-management/archive/2.5.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/2.5.tar.gz
...
%prep
%setup -q -n clear-config-management-2.5

...
Version  : 3.0
Release  : 19
URL      : https://github.com/clearlinux/clear-config-management/archive/3.0.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/3.0.tar.gz
...
%prep
%setup -q -n clear-config-management-3.0

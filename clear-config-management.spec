...
Version  : 5.2
Release  : 40
URL      : https://github.com/clearlinux/clear-config-management/archive/5.2.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/5.2.tar.gz
...
%prep
%setup -q -n clear-config-management-5.2

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489347840

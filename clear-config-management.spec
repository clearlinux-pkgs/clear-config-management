...
Version  : 5.0
Release  : 38
URL      : https://github.com/clearlinux/clear-config-management/archive/5.0.tar.gz
Source0  : https://github.com/clearlinux/clear-config-management/archive/5.0.tar.gz
...
%prep
%setup -q -n clear-config-management-5.0
